...
This project explores how the Witness System can counteract that harm through an equity-aware Oi→Si reconstruction layer.
...
- It captures the human experience and the narrative framing.
...
- `notes.md` — Reflections and thematic observations that arise during the conversations.
- `drafts/` — Early narrative or analytic writing that will later move into the Writing pillar.
...
Everything here is part of the developmental record of a pillar built for real people in real linguistic conditions.

## Status
Active · Foundational · Evolving  
This directory will grow as the project deepens and as more conversations are captured and analyzed.
